...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: NavigationMenu(),  // Gunakan NavigationMenu sebagai halaman utama
    );
  }
}
    ...
    return GridView.builder(
      ...
      itemBuilder: (BuildContext context, int index) {
        return GestureDetector(
          onTap: () {
            navigateToDetail(
                context, 'Kambing Item $index', 'image/hewan_kurban.png');
          },
          child: Container(
            decoration: BoxDecoration(
    ...
    return GridView.builder(
      ...
      itemBuilder: (BuildContext context, int index) {
        return GestureDetector(
          onTap: () {
            navigateToDetail(
                context, 'Sapi Item $index', 'image/sapi_kurban.png');
          },
          child: Container(
            decoration: BoxDecoration(
